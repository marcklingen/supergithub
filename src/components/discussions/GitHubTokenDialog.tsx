    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            <p className="mb-4">
              A GitHub token with <code className="bg-muted px-1 py-0.5 rounded">repo</code>, <code className="bg-muted px-1 py-0.5 rounded">write:discussion</code>, and <code className="bg-muted px-1 py-0.5 rounded">write:issue</code> scopes is required to access and comment on discussions.
            </p>
            <ol className="list-decimal pl-5 space-y-2 text-sm">
              ...
              <li>Create a new token (classic) with these scopes:
                <ul className="list-disc pl-5 mt-1">
                  ...
                  <li><code className="bg-muted px-1 py-0.5 rounded">write:discussion</code> (for discussion comments)</li>
                  <li><code className="bg-muted px-1 py-0.5 rounded">write:issue</code> (may be needed for some repositories)</li>
                </ul>
              </li>
