  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mt-8 text-sm text-muted-foreground text-center">
        <p>Use <kbd className="px-1.5 py-0.5 rounded bg-muted border">j</kbd>/<kbd className="px-1.5 py-0.5 rounded bg-muted border">k</kbd> or arrow keys to navigate, <kbd className="px-1.5 py-0.5 rounded bg-muted border">Enter</kbd> to select</p>
      </div>
    </div>
  );
};
